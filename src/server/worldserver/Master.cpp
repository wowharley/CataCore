...
int Master::Run()
{
    ...
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "CataCore 2016");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "my Skype cooler19860212");
    sLog->outInfo(LOG_FILTER_WORLDSERVER, "World of Warcraft Cataclysm 4.3.4a");
